...
import {Briefcase, Building2, MapPin, Tags, Info, Users, DollarSign, Calendar,} from "lucide-react";
...
const index = () => {
  ...
  const handlesubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await axios.post("https://internshala-clone-uclt.onrender.com/api/internship", formData);
